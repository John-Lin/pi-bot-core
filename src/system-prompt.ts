...
### Silent Completion
If a periodic check finds nothing to report, respond with just \`[SILENT]\` (no other text). Nothing is posted — keeps the ${noun} quiet when there's nothing actionable.
